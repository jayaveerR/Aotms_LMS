...
const WhyAOTMS = () => (
  <section id="about" className="relative py-16 md:py-24 overflow-hidden bg-transparent">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {features.map((f, i) => (
          ...
          >
            <div className="h-full relative group">
              ...
              <div className="relative h-full bg-white/95 backdrop-blur-sm border border-slate-900/10 rounded-[2.5rem] rounded-tr-none p-8 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-[#0075CF]/10 hover:-translate-y-2 transition-all duration-500 flex flex-col overflow-hidden">
      ...
      >
        <div className="relative grid grid-cols-2 md:grid-cols-4 gap-4 bg-white/98 backdrop-blur-sm rounded-[2.9rem] p-8 md:p-12 border border-white/50">
          {[
