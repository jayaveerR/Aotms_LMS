    ...
    <footer id="contact" className="relative bg-[#0075CF] text-[#FDFEFE] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-[#FDFEFE]/70 text-sm md:text-base leading-relaxed mb-6 max-w-sm">
              Vijayawada's premier LMS platform for skill-based learning, secure exams, and 100% placement support.
            </p>
            {/* Contact info */}
            <div className="flex flex-col gap-3">
              <a href="tel:+919876543210" className="flex items-center gap-2 text-[#FDFEFE]/70 hover:text-[#FDFEFE] text-sm transition-colors">
                <Phone className="w-4 h-4 text-[#FD5A1A] flex-shrink-0" /> (+91) 98765-43210
              </a>
              <a href="mailto:hello@aotms.com" className="flex items-center gap-2 text-[#FDFEFE]/70 hover:text-[#FDFEFE] text-sm transition-colors">
                <Mail className="w-4 h-4 text-[#FD5A1A] flex-shrink-0" /> hello@aotms.com
              </a>
              <div className="flex items-start gap-2 text-[#FDFEFE]/70 text-sm">
          ...
          {Object.entries(links).map(([title, items]) => (
            <div key={title}>
              ...
              <ul className="space-y-3">
                {items.map((item) => (
                  <li key={item}>
                    <a href="#" className="text-[#FDFEFE]/70 hover:text-[#FD5A1A] text-sm transition-colors leading-relaxed">
                      {item}
                    </a>
                  </li>
                ))}
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-5">
            <div>
              <p className="font-bold text-[#FDFEFE] text-base">Stay updated with AOTMS</p>
              <p className="text-[#FDFEFE]/70 text-sm">Get course updates, placement news & tech tips weekly.</p>
            </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[#FDFEFE]/50 text-sm">© {year} AOTMS. All rights reserved.</p>
