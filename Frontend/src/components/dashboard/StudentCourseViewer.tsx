                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="aspect-video bg-black/95 rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative group">
                        {!localIsEnrolled ? (
                            ...
                            >
                                <source src={selectedVideo.video_url.startsWith('http') ? selectedVideo.video_url : `https://new-lms-m5l5.onrender.com/api/s3/public/${selectedVideo.video_url}`} type="video/mp4" />
