    ...
    variants: {
      variant: {
        ...
        link: "text-primary underline-offset-4 hover:underline",
         accent: "bg-accent text-accent-foreground hover:scale-[1.03] shadow-soft hover:shadow-glow-orange",
         hero: "bg-primary text-primary-foreground hover:scale-[1.03] shadow-soft hover:shadow-glow-blue",
         "hero-outline": "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-primary-foreground",
         "cta-white": "border-2 border-primary-foreground/30 text-primary-foreground bg-transparent hover:bg-primary-foreground/10",
      },
      size: {
