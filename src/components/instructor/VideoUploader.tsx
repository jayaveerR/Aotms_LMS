...
import { useVideos, useTopics, useCreateVideo, useDeleteVideo, uploadVideo } from '@/hooks/useInstructorData';
import { Plus, Video, Trash2, Upload, Eye, Clock, PlayCircle } from 'lucide-react';
...
export function VideoUploader({ courseId }: VideoUploaderProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setNewVideo({ title: '', description: '', topic_id: '', is_published: false });
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Upload and manage recorded lectures</CardDescription>
          </div>
          <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
            ...
            <DialogContent className="sm:max-w-lg">
              <DialogHeader>
                ...
                <DialogDescription>Add a new video to your course</DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setNewVideo({ ...newVideo, is_published: checked })}
                  />
                </div>
              </div>
              <DialogFooter>
                <Button variant="outline" onClick={() => setIsAddOpen(false)}>Cancel</Button>
                <Button onClick={handleUpload} disabled={uploading || !selectedFile || createVideo.isPending}>
